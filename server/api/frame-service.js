...
export const processUserData = frameService.processUserData.bind(frameService);
export const fetchFollowing = frameService.fetchFollowing.bind(frameService);
export const extractWalletAddresses = frameService.extractWalletAddresses.bind(frameService);
export const fetchUserDetails = frameService.fetchUserDetails.bind(frameService);
export const fetchTradingData = frameService.fetchTradingData.bind(frameService);
export const generateTopTradersImage = frameService.generateTopTradersImage.bind(frameService);
export const generateUserFrameHtml = frameService.generateUserFrameHtml.bind(frameService);